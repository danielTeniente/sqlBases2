...
begin catch
print('Error al insertar universidades')
rollback tran
end catch
...
begin catch
print('Error al insertar facultades')
rollback tran
end catch
...
begin catch
print('Error al insertar carreras')
rollback tran
end catch
--select * from CARRERA;
begin try
...
begin catch
print('Error al insertar directores')
rollback tran
end catch
...
begin catch
print('Error al insertar profesores')
rollback tran
end catch
--select * from PROFESOR;
begin try
begin tran 
INSERT INTO UNIVERSIDAD_PROFESOR VALUES ('Profesor tiempo completo', 'ESPE', 'P001' );
INSERT INTO UNIVERSIDAD_PROFESOR VALUES ('Profesor', 'UDLA', 'P002' );
INSERT INTO UNIVERSIDAD_PROFESOR VALUES ('Profesor', 'ESPE', 'P003' );
INSERT INTO UNIVERSIDAD_PROFESOR VALUES ('Profesor', 'UDLA', 'P004' );
INSERT INTO UNIVERSIDAD_PROFESOR VALUES ('Profesor', 'UDLA', 'P005' );
commit tran
end try
begin catch
print('Error al unir universidades con profesores')
rollback tran
end catch
...
begin catch
print('Error al insertar trabajos de titulación')
rollback tran
end catch
...
INSERT INTO AVANCE VALUES ('A006', 'Avance dos', '12/11/2018', 'T001' );
commit tran
end try
begin catch
print('Error al insertar avances')
rollback tran
end catch
...
begin catch
print('Error al insertar comentarios')
rollback tran
end catch
